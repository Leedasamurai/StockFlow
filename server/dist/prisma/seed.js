...
// Delets all data on data ase before hand
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Logic to grab each file and GET the correect name and data
        for (const fileName of orderedFileNames) {
            ...
            // create and model schemas pass the data into each schema
