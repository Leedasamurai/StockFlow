...
import { Bell, Menu, Search, Settings, Sun, SunMoon } from "lucide-react";
      ...
      <div className="flex justify-between items-center gap-5">
        ...
        <div className="relative">
          <input
            type="search"
            placeholder="search"
            className="pl-10 pr-4 py-2 w-50 md:w-70 border-gray-300 bg-white rounded-lg focus:outline-none focus:border-blue-500"
          />
      ...
      <div className="flex justify-between items-center gap-5">
        <div className="hidden md:flex justify-between items-center gap-5">
          <div>
            <button onClick={toggleDarkMode}>
              {isDarkMode ? (
                ...
                <SunMoon className="cursor-pointer text-gray-500" size={24} />
              )}
            </button>
          </div>
          <div className="relative">
          ...
          <div className="flex item-center gap-3 cursor-ponter">
            ...
            />
            <span className="font-semibold">Cyril Ramaphosa</span>
          </div>
        </div>
        <Link href="/settings">
